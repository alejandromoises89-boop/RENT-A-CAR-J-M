...
def init_db():
    ...
    autos = [
        ("Hyundai Tucson Blanco", 260.0, "https://i.ibb.co/rfG4Kmk3/1000169702-removebg-preview-1.png", "Disponible", "AAVI502", "Blanco"),
        ("Toyota Vitz Blanco", 195.0, "https://i.ibb.co/rfG4Kmk3/1000169702-removebg-preview-1.png", "Disponible", "AAVP719", "Blanco"),
